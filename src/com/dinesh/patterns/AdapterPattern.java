 ...
 * [1] An adapter allows classes to work together that normally 
 * could not because of incompatible interfaces
 */
public class AdapterPattern {
	static class CountriesInterface {
		public List<String> getList() {
			List<String> countries = Arrays.asList("IND", "US", "UK");
			return countries;
		}
	}
	...
	static class CountriesAdapter {
		...
		static {
			...
			countryCodeNameMapping.put("US", "United States");
			countryCodeNameMapping.put("UK", "United Kingdom");
		...
		public List<String> getTranslatedList() {
			...
			for (String country : countryCodes) {
				countryNames.add(countryCodeNameMapping.get(country));
			}
			return countryNames;
		}
	}
	...
	public static void main(String[] args) {
		System.out.println(new CountriesAdapter().getTranslatedList());
	}
}